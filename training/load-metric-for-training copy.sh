...
echo "  "
echo "  "
    oc exec -ti -n $AIOPS_NAMESPACE aiops-topology-cassandra-0 -- bash -c "mkdir -p /home/ibm/metrics"
    oc rsync -n $AIOPS_NAMESPACE ./training-data/$VERSION/$INDEX_TYPE/ aiops-topology-cassandra-0:/home/ibm/metrics
echo "  "
echo "  "
